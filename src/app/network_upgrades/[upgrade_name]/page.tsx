    ...
    async function getData() {
      ...
      if (doc) {
        setData({
          ...
          updates: doc3 as UpdatesData[],
          resources: doc4 as ResourcesData[],
          videos: doc5 as VideosData[],
        });
      } else {
              ...
              {data?.updates.length !== 0 ? (
                <div className="flex flex-col lg:border-r lg:border-b-0 border-b gap-y-4 lg:pb-0 pb-8 border-darkGray border-dashed">
                  ...
                  <div className="flex flex-col-reverse justify-end gap-y-2 ">
                    {data?.updates.map((item: UpdatesData, index) => {
                      return (
                        <div
                          key={index}
              ...
              <div className="flex flex-col gap-y-8 px-8">
                {data?.videos?.length !== 0 ? (
                  <div className="flex flex-col gap-y-4">
                    ...
                    {data?.videos.map((item: VideosData, index) => {
                      return (
                        <span
                          key={index}
                ...
                {data?.resources?.length !== 0 ? (
                  <div className="flex flex-col gap-y-4">
                    ...
                    {data?.resources.map((item: ResourcesData, index) => {
                      return (
                        <span
                          key={index}
                          className="lg:text-xl md:text-lg text-md font-roboto font-thin"

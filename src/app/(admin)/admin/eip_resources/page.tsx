                ...
                <div
                  ...
                  className={`${
                    selectedTitleId === title.id
                      ? "text-darkGray"
                      : "text-lightGray"
                  } cursor-pointer flex w-fll justify-between items-center`}
                  key={index}
                >
                  {title.title}
        ...
        <>
          <div className="border border-darkGray rounded-lg md:p-6 p-3 flex flex-col gap-y-4">
            {eipResourceTitle?.resources?.map((resource, index) => (
              <>
                <div
                  className={`'text-lightGray cursor-pointer flex w-fll justify-between items-center`}
                  key={index}
                >
